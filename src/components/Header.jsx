...
function Header() {
  return (
    <section className='grid grid-cols-1 lg:grid-cols-2 items-center'>
        <div className='lg:w-8/12 m-auto sm:mt-10 lg:mt-20'>
            <h1 className='lg:text-7xl text-2xl m-auto sm:w-9/12 ' style={{fontWeight: 'bolder'}}>Make <br className='sm:hidden'/> Remote Work</h1>
            <h1 className='text-base font-normal sm:my-5 lg:my-10 sm:text-center lg:w-8/12'>Get your team in sync, no matter your location, stremline processes, create team rituals, and watch productivity soar</h1>
            <button className='border-2 p-3 px-6 sm:ml-20 rounded-xl bg-black text-white text-base transition ease-in-out duration-700 hover:bg-white hover:text-black'>Learn More</button>
